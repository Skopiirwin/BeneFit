# app/models/accessory_measurement.rb
class AccessoryMeasurement < Measurement
  before_validation :set_measurement_type

  validates :wrist_circumference, :wrist_width,
            numericality: { greater_than: 0 }, allow_nil: true

  private

  def set_measurement_type
    self.measurement_type = 'accessory'
  end

  def wrist_measurements
    {
      wrist_circumference: wrist_circumference,
      wrist_width: wrist_width
    }
  end
end app/models/footwear_measurement.rb
